...
export const typography = {
  ...
  h1: {
    ...
    fontSize: "108px",
    fontWeight: 300,
    ...responsiveFontSizes({ sm: 28, md: 42, lg: 108 }),
  },
  h2: {
    fontFamily: primaryFont,
    fontSize: "68px",
    fontWeight: 300,
    ...responsiveFontSizes({ sm: 26, md: 40, lg: 68 }),
  },
  h3: {
    fontFamily: primaryFont,
    fontSize: "54px",
  ...
  h5: {
    ...
    fontSize: "27px",
    fontWeight: 400,
    ...responsiveFontSizes({ sm: 16, md: 23, lg: 20 }),
  },
  h6: {
    fontFamily: primaryFont,
    fontSize: "23px",
    fontWeight: 500,
    ...responsiveFontSizes({ sm: 15, md: 19, lg: 18 }),
  },
  subtitle1: {
    fontFamily: primaryFont,
    fontWeight: 400,
...
export const customTypography = {
  h1_48: {
    ...
    fontWeight: 300,
    lineHeight: "150%",
    ...responsiveFontSizes({ sm: 23, md: 36, lg: 48 }),
  },
  h4_38: {
    fontFamily: primaryFont,
    fontSize: "38px",
  ...
  h2_34: {
    ...
    fontWeight: 300,
    lineHeight: "150%",
    ...responsiveFontSizes({ sm: 22, md: 28, lg: 34 }),
  },
  h3_28: {
    fontFamily: primaryFont,
    fontSize: "28px",
  ...
  text_27: {
    ...
    fontWeight: 600,
    lineHeight: "150%",
    ...responsiveFontSizes({ sm: 18, md: 23, lg: 27 }),
  },
  h4_23: {
    fontFamily: primaryFont,
    fontSize: "23px",
    fontWeight: 400,
    lineHeight: "150%",
    ...responsiveFontSizes({ sm: 15, md: 19, lg: 23 }),
  },
  bold_16: {
    fontFamily: primaryFont,
    fontWeight: 600,
